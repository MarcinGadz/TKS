...
public class RentalView {
    ...
    public RentalView(UUID rentalID, String clientId, String recordId) throws InputExceptionView {
        this(rentalID, clientId, recordId, LocalDateTime.now(), LocalDateTime.now().plusDays(7), null, true);
    }

    public RentalView(String clientId, String recordId) throws InputExceptionView {
