...
public class UserRepository {
    ...
    public UserRepository() {
        UserEntity[] arr = {
                new UserEntity(UUID.fromString("cebbee82-2398-4dc2-a94d-a4c863286ff0"), "Eleanora", true, UserTypeEntity.CLIENT, false),
                new UserEntity(UUID.fromString("bbe979ba-ed9c-4028-8c18-97740c25ae99"), "Jason", false, UserTypeEntity.CLIENT, false),
                new UserEntity(UUID.fromString("c6f3fbf7-135b-498e-8154-3a5b9d291145"), "Chidi", true, UserTypeEntity.CLIENT, false),
                new UserEntity(UUID.fromString("f6abb370-5dbb-4473-bf8d-505bdcf6ccce"), "Tahani", true, UserTypeEntity.CLIENT, false),
                new UserEntity(UUID.fromString("73d2c12b-179e-4700-879d-8e3de56fe55f"), "Michael", true, UserTypeEntity.ADMINISTRATOR, false),
                new UserEntity(UUID.fromString("bfac0aaa-e7d2-4e33-9fa9-8111b14bcd58"), "DiscoJanet", true, UserTypeEntity.CLIENT, false)
        };
